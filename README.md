...
### Пайплайн
Пайплайн неплохо справляется с задачей, довольно неплохо отличает лица, пример в ноутбуке. Для детекции использовал MTCNN как одно из самых популярных решений.

## Модификация с использованием ViT
### Детекция лиц и выравнивание лиц
За счет использования HG блока + ViT сеть стала легковеснее, что позволило обучать ее на 3060 (6gb) вместо коллабовской Т4 на 15гб. Качество осталось примерно на том же уровне, инференс стал быстрее. Обучение заняло меньше времени в сравнении с прошлой архитектурой
### Рапспознавание лиц
Комбинированная архитектура ResNet50 + ViT позволила улучшить итоговое accuracy до 79,87% при обучении на меньшем кол-ве эпох. В дополнение были использованы GeM Pooling, оптимизированы гиперпараметры сети под новую архитектуру и еще пара небольших фишек (например: label smoothing у CE от переобучения и др.)
